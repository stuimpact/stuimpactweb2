    ...
    return (
        <div className="min-h-screen bg-white text-gray-800 overflow-x-hidden">
                ...
                <div className="flex flex-col md:flex-row">
                    <aside className="w-full md:w-1/4 pr-0 md:pr-8 mb-8 md:mb-0">
                        ...
                        <div className={`md:block ${filtersOpen ? "block" : "hidden"}`}>
                            ...
                            <h2 className="text-lg font-semibold mt-4 mb-4">Refine by Grade</h2>
                            <div className="space-y-2">
                    ...
                    <section className="w-full md:w-3/4">
                        {jobs.length > 0 ? (
                            <div className="grid gap-6 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
                                {jobs.map((job, index) => {
                                    // Extract grade levels and types from the tags
            ...
            <footer className="bg-gray-800 text-white py-4 text-center">
                <p>&copy; 2024 StuImpact. All rights reserved.</p>
            </footer>
        </div>
    );
}
