					...
					<div className="container mx-auto px-4 py-8">
						...
						<nav className="flex flex-col space-y-6">
							...
							<Link href="/opportunities" onClick={toggleMenu}>
								<Button className="w-full bg-blue-600 text-white hover:bg-blue-700 shadow-md hover:shadow-lg">
									Find Opportunities
								</Button>
							</Link>
						</nav>
			...
			<main className="container mx-auto px-4 py-20 relative z-10">
				<div className="text-center mb-12">
					...
					<p className="text-lg text-gray-600 max-w-2xl mx-auto">
						The Contact Form can be used for internship messages,
						partnership requests, and general messages on StuImpact.
						Thank you!
					</p>
				</div>
				<form
				...
				>
					<div className="mb-6">
						<label
							className="block font-medium mb-2 text-md"
							htmlFor="name"
						>
							Name
						</label>
					...
					<Button
						type="submit"
						className="w-full bg-blue-600 text-white hover:bg-blue-700 shadow-md hover:shadow-lg"
					>
						Send Message
					</Button>
				</form>
